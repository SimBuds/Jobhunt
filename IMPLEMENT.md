...
No work in progress. The next non-trivial task populates the "Active plan"
section below using the phase template.

## Active plan

_(empty — copy the template below per phase when a plan is approved)_
